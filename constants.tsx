...
export const services = [
    { slug: 'pilotage-planification', title: 'Pilotage & Planification', subTitle: 'Construire', description: 'les outils indispensables à une gestion financière et opérationnelle optimale : reporting, business plan et prévisionnel de trésorerie etc.', icon: <PaperPlaneIcon />, iconClassName: 'w-16 h-16' },
