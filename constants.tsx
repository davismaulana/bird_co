...
export const services = [
    ...
    { slug: 'services-ma', title: 'Services M&A', subTitle: 'Accompagner', description: 'vos projets capitalistiques : cession, levée de fonds, croissance externe et réorganisation.', icon: <img src="https://images2.imgbox.com/91/32/P6brUIBM_o.png" alt="Services M&A Icon" />, iconClassName: 'w-20 h-20' },
];
...
export const teamMembers = [
  {
    ...
    role: 'Co-fondateur',
    description: [
      'Spécialiste des situations complexes, il excelle dans la structuration financière, stratégique et opérationnelle.',
      'Son parcours est marqué par sa résilience et sa créativité dans des processus transactionnels exigeants.',
      'Passionné de musique et de cinéma, il allie un esprit curieux à un sens aigu du détail.',
    ],
  ...
  },
  {
    ...
    role: 'Co-fondateur',
    description: [
      'Expert en M&A, il assiste entreprises et fonds dans leurs processus de cessions-acquisitions et de due diligence.',
      'Il possède une solide expérience en Direction financière de start-ups et ETI, notamment en levées de fonds.',
      'Ancien footballeur semi-professionnel, il est guidé par la discipline, la stratégie et l’engagement.',
    ],
