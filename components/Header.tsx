              ...
              <nav className="flex items-center space-x-2">
                {navItems.map((item) => {
                  if (item.name === 'Solutions') {
                    ...
                    let classes = 'nav-link-anchor px-4 py-2 rounded-lg text-sm font-bold transition-colors flex items-center gap-2';
                    if (hasBackground) {
                  ...
                  const finalClasses = ['px-4', 'py-2', 'rounded-lg', 'text-sm', 'font-bold', 'transition-colors'];
              ...
              {navItems.map((item) => {
                  ...
                  return (
                    <div key={item.name} className="w-full">
                       <button
                         ...
                         className={`block w-full text-xl font-bold py-3 rounded-lg hover:bg-[#27013D] hover:text-white transition-colors text-center ${
                ...
                return (
                  <a
                    ...
                    href={item.href}
                    onClick={() => setIsMobileMenuOpen(false)}
                    className={`block w-full text-xl font-bold py-3 rounded-lg hover:bg-[#27013D] hover:text-white transition-colors ${
