              ...
              <nav className="flex items-center space-x-2">
                {navItems.map((item) => {
                  if (item.name === 'Solutions') {
                    ...
                    let classes = 'nav-link-anchor px-4 py-2 rounded-lg text-base font-light transition-colors flex items-center gap-2';
                    if (hasBackground) {
                  ...
                  const finalClasses = ['px-4', 'py-2', 'rounded-lg', 'text-base', 'font-light', 'transition-colors'];
