    ...
    <div className="bg-white">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="text-gray-800 space-y-8 text-base leading-relaxed">
                <Animate variant="pop">
                    <h2 className="text-2xl font-bold text-[#27013D]">Article 1 - Objet et Champ d'application</h2>
                ...
                <Animate variant="pop" delay={100}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 2 - Devis et Commandes</h2>
                ...
                <Animate variant="pop" delay={200}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 3 - Durée des Prestations</h2>
                ...
                <Animate variant="pop" delay={300}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 4 - Tarifs et Modalités de paiement</h2>
                ...
                <Animate variant="pop" delay={400}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 5 - Obligations des parties</h2>
                ...
                <Animate variant="pop" delay={500}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 6 - Propriété Intellectuelle</h2>
                ...
                <Animate variant="pop" delay={600}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 7 - Confidentialité</h2>
                ...
                <Animate variant="pop" delay={700}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 8 - Responsabilité</h2>
                ...
                <Animate variant="pop" delay={800}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 9 - Non-sollicitation de personnel</h2>
                ...
                <Animate variant="pop" delay={900}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 10 - Indépendance des parties</h2>
                ...
                <Animate variant="pop" delay={1000}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 11 - Résiliation</h2>
                ...
                <Animate variant="pop" delay={1100}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 12 - Force Majeure</h2>
                ...
                <Animate variant="pop" delay={1200}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 13 - Références Commerciales</h2>
                ...
                <Animate variant="pop" delay={1300}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 14 - Intégralité et Divisibilité</h2>
                ...
                <Animate variant="pop" delay={1400}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">Article 15 - Droit applicable et Juridiction</h2>
