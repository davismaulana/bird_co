      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="text-gray-800 space-y-8 text-base leading-relaxed">
                <Animate variant="pop">
                    <h2 className="text-2xl font-bold text-[#27013D]">1. Éditeur du Site</h2>
                ...
                <Animate variant="pop" delay={100}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">2. Directeur de la publication</h2>
                    <p>Le directeur de la publication est Monsieur Seydina SAMB, en sa qualité de Président de la société BIRD&CO.</p>
                </Animate>

                <Animate variant="pop" delay={200}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">3. Hébergeur du Site</h2>
                ...
                <Animate variant="pop" delay={300}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">4. Propriété intellectuelle</h2>
                 ...
                 <Animate variant="pop" delay={400}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">5. Données personnelles (RGPD)</h2>
                ...
                <Animate variant="pop" delay={500}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">6. Cookies</h2>
                ...
                <Animate variant="pop" delay={600}>
                    <h2 className="text-2xl font-bold text-[#27013D] pt-4">7. Droit applicable</h2>
