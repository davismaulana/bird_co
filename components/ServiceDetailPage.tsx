...
const ServiceDetailPage: React.FC<{ serviceId: string }> = ({ serviceId }) => {
  ...
  return (
    <div className="bg-white text-gray-800">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#27013D] to-gray-900 text-white flex items-center overflow-hidden min-h-[50vh] pt-32 pb-16 md:pt-40 md:pb-24">
