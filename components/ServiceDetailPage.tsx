          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {details.diagnostic.content && (
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-start max-w-7xl mx-auto">
                  <Animate variant={'pop'} delay={300} className="lg:col-span-3 aspect-[4/3] lg:aspect-auto relative lg:top-4">
                      {details.diagnostic.content.visual}
                  </Animate>
                  <Animate variant={'pop'} delay={200} className="lg:col-span-2 relative lg:top-4 lg:pt-6">
