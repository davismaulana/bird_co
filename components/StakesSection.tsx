        ...
        <div className="relative max-w-6xl mx-auto py-4">
          ...
          <div className="absolute top-40 bottom-32 left-1/2 w-px -translate-x-1/2 hidden sm:block pointer-events-none">
            <div className="running-dot-wrapper-stakes">
              <div className="running-dot-indicator running-dot-indicator-stakes"></div>
            </div>
          </div>
          ...
          <div className="space-y-12">
            {stakes.map((stake, index) => {
              ...
              const circlePositionClass = 'top-1/2 -translate-y-1/2';
              ...
              return (
                <div key={index} className="sm:relative sm:flex sm:items-center">
                  <div className={`sm:w-1/2 ${onRightSide ? 'sm:order-3 sm:pl-8' : 'sm:order-1 sm:pr-8'}`}>
                    <div className={`bg-white rounded-xl p-6 border border-gray-200/80 shadow-lg hover:shadow-2xl hover:shadow-violet-100/50 transition-all duration-300 transform hover:scale-105 stake-content-card stake-content-card--${index + 1}`}>
                      {/* Mobile Header */}
